...
public class AuftragsUebersichtView extends JXPanel {
	...
	private JXTable createAuftragsTable() {
		...
		tableModel.addRow(new AuftragsRow(4, "SHIFT Geb�udemanagement",
				"erledigt", "10.02.2015", "Wasser"));
		tableModel.addRow(new AuftragsRow(5, "SHIFT Geb�udemanagement",
				"offen", "26.03.2015", "Hecke schneiden"));
		tableModel.addRow(new AuftragsRow(6, "SHIFT Geb�udemanagement",
